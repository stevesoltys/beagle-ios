...
final public class ComponentDecoder: ComponentDecoding {
    ...
    private func registerActions() {
        ...
        registerAction(While.self, key: key(name: "While", namespace: .beagle))
        registerAction(FirebaseSignIn.self, key: key(name: "FirebaseSignIn", namespace: .beagle))
        registerAction(FirebaseSignOut.self, key: key(name: "FirebaseSignOut", namespace: .beagle))
    ...
    private func registerUITypes() {
        ...
        registerComponent(Switch.self, key: key(name: "Switch", namespace: .beagle))
        ...
        registerComponent(BottomNavigationBar.self, key: key(name: "BottomNavigationBar", namespace: .beagle))
    }
