...
extension FirebaseSignUp: AsyncAction {
    ...
    public func execute(controller: BeagleController, origin: UIView) {
        ...
        Auth.auth().createUser(withEmail: emailEvaluated, password: passwordEvaluated) { authResult, error in
            
            if let error = error {
                print("Sign up errored: \(error)")
